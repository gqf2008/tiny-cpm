//! GPT-2 backbone for MOSS-TTS-Nano.
//!
//! Ported from aha (github.com/jhqxxx/aha) src/models/gpt2/mod.rs
use anyhow::Result;
...
use crate::{
    common::modules::{TwoLinearMLP, eager_attention_forward, get_layer_norm},
