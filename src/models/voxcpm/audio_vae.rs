//! Ported from aha (github.com/jhqxxx/aha) src/models/voxcpm/audio_vae.rs
...
// Inlined from aha src/utils/mod.rs (`crate::utils::bucketize`); tiny-cpm utils has no bucketize.
fn bucketize(input: usize, boundaries: &[usize]) -> Result<usize> {
